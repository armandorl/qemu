...
PERFORM_WRITE(REG_MUX_3_CSC, val);
			PERFORM_WRITE(REG_MUX_3_CSC, PERFORM_READ(REG_MUX_3_CSC) & 0xFFFFFFF0); /* Auto clear */
...
PERFORM_WRITE(REG_MUX_12_CSC, val);
			PERFORM_WRITE(REG_MUX_12_CSC, PERFORM_READ(REG_MUX_12_CSC) & 0xFFFFFFF0); /* Auto clear */
...
PERFORM_WRITE(REG_MUX_16_CSC, val);
			PERFORM_WRITE(REG_MUX_16_CSC, PERFORM_READ(REG_MUX_16_CSC) & 0xFFFFFFF0); /* Auto clear */
...
PERFORM_WRITE(REG_MUX_15_CSC, val);
			PERFORM_WRITE(REG_MUX_15_CSC, PERFORM_READ(REG_MUX_15_CSC) & 0xFFFFFFF0); /* Auto clear */
...
PERFORM_WRITE(REG_MUX_4_CSC, val);
			PERFORM_WRITE(REG_MUX_4_CSC, PERFORM_READ(REG_MUX_4_CSC) & 0xFFFFFFF0); /* Auto clear */
...
PERFORM_WRITE(REG_MUX_6_CSC, val);
			PERFORM_WRITE(REG_MUX_6_CSC, PERFORM_READ(REG_MUX_6_CSC) & 0xFFFFFFF0); /* Auto clear */
...
PERFORM_WRITE(REG_MUX_5_CSC, val);
			PERFORM_WRITE(REG_MUX_5_CSC, PERFORM_READ(REG_MUX_5_CSC) & 0xFFFFFFF0); /* Auto clear */
PERFORM_WRITE(REG_MUX_5_CSS, (PERFORM_READ(REG_MUX_5_CSC) & 0x3F000000) | BIT(17));
;			break;
		case REG_MUX_10_CSC:
PERFORM_WRITE(REG_MUX_10_CSC, val);
			PERFORM_WRITE(REG_MUX_10_CSC, PERFORM_READ(REG_MUX_10_CSC) & 0xFFFFFFF0); /* Auto clear */
PERFORM_WRITE(REG_MUX_10_CSS, (PERFORM_READ(REG_MUX_10_CSC) & 0x3F000000) | BIT(17));
;			break;
		case REG_MUX_8_CSC:
PERFORM_WRITE(REG_MUX_8_CSC, val);
			PERFORM_WRITE(REG_MUX_8_CSC, PERFORM_READ(REG_MUX_8_CSC) & 0xFFFFFFF0); /* Auto clear */
...
PERFORM_WRITE(REG_MUX_1_CSC, val);
			PERFORM_WRITE(REG_MUX_1_CSC, PERFORM_READ(REG_MUX_1_CSC) & 0xFFFFFFF0); /* Auto clear */
